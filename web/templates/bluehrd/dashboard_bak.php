			...
			<div class="row">
				...
				<div class="col-md-8">
					...
					<div class="panel panel-default panel-newsfeed">
						...
						<div class="panel-footer">
							...
							<button type="button" class="btn btn-link btn-sm">LIHAT SEMUA</button>
							</a>
							</div>
							<nav aria-label="Page navigation" id="pagination_link">
					...
					<div class="page-header">
						<h3><span class="far fa-comments fa-fw fa-lg text-danger" aria-hidden="true"></span> BIRDBAGI FORUM</h3>
					</div>
					<div class="row">
						<?php if($toptri_forum_post_list): ?>
						<div class="col-md-8">
							...
							<?php foreach($toptri_forum_post_list as $k => $v): ?>
								...
								<div class="row">
									<div class="col-md-8 col-sm-8">
										<div class="help-block">
										Oleh <a><b><?php echo $v->USR_NAME; ?></b></a> 
										pada <?php echo $post_date; ?> </a>
										</div>
									</div>
									<div class="col-md-4 col-sm-4 text-right">
										<div class="help-block">
					...
					<!-- Panels Gallery ini akan diganti daftar postingan Gaya Hidup (Forum) -->
					<div class="panel panel-events panel-default hidden">
						<div class="panel-badge">
							<span class="far fa-calendar-alt fa-fw"></span> Gallery
						</div>
						<img src="<?php echo template_img(); ?>/blogs/2.jpg" class="img-responsive">
						<div class="panel-caption">
							<div class="help-block">27 Desember 2017</div>
							<h3>Blue Bird Perkuat Akses Layanan di Padang melalui Peluncuran Aplikasi ‘My Blue Bird’</h3>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="panel panel-box panel-danger">
						...
						<a href="<?php echo base_url()."dashboard/birthday";?>">Lihat <span class="fas fa-chevron-right fa-fw" aria-hidden="true"></span></a>
						</div>
					</div>
					<div class="panel panel-box panel-warning">
						<div class="panel-heading">
							<a href="<?php echo base_url()."pages/formulir-manual-bluebird";?>">
								<h4>PUSAT INFORMASI KARYAWAN</h4>
								<h2>Unduh Formulir</h2>
								<p><b>Pusat informasi karyawan serta pengunduhan.</b></p>
								<p class="lead hidden">2</p>
							</a>
						</div>
						<div class="panel-footer text-right">
						<a href="<?php echo base_url()."informasi";?>">Lihat <span class="fas fa-chevron-right fa-fw" aria-hidden="true"></span></a>
						</div>
					</div>
					<div class="panel panel-box panel-success">
						<div class="panel-heading">
							<a href="<?php echo base_url()."bblearning";?>">
								...
								<p class="lead hidden">3</p>
							</a>
						</div>
						<div class="panel-footer text-right">
						<a href="<?php echo base_url()."bblearning";?>">Lihat <span class="fas fa-chevron-right fa-fw" aria-hidden="true"></span></a>
						</div>
					</div>
					<div class="panel panel-box panel-primary">
						<div class="panel-heading">
							<a href="<?php echo base_url()."qa";?>">
								...
								<p class="lead hidden">4</p>
							</a>
						</div>
						<div class="panel-footer text-right">Lihat <span class="fas fa-chevron-right fa-fw" aria-hidden="true"></span></div>
					</div>
					<div class="panel panel-box panel-info hidden">
						<div class="panel-heading">
							<a href="<?php echo base_url()."profile";?>">
								<h4>Data Diri</h4>
								<h2>Lihat Data Diri</h2>
								<p><b>Perbaharui akses data diri anda disini.</b></p>
								<p class="lead hidden">5</p>
							</a>
						</div>
						<div class="panel-footer text-right">
						<a href="<?php echo base_url()."profile";?>">Lihat <span class="fas fa-chevron-right fa-fw" aria-hidden="true"></span></a>
						</div>
					</div>
					<!-- Berita Populer -->
