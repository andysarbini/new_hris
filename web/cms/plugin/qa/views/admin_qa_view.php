...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4>
			...
			<a href="<?php echo base_url()."qa/user" ;?>" >Bantuan / Pertanyaan</a> &gt;&gt; <?php echo $qa->subjek;?></b>
		</h4>
	</div>
	...
	<div class="media">
		<div class="panel-body">
			<div class="media-left">
				...
				<img class="media-object thumbnail" src="<?php echo base_url()."uploads/profile/".$val->profile_picture; ?>" alt="" width="75">
				</a>
			</div>
...
<div class="panel panel-default">
	...
	<div class="panel-body">
		<form action="<?php echo base_url()."qa/admin/reply_answer";?>" method="post">
