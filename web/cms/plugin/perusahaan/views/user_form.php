                ...
                <div class="ibox float-e-margins">
                  ...
                  <div class="ibox-content">
                    ...
                    <?php foreach ($perusahaan as $var=>$v) : ?>
                        <tr>
                            <td><a href="<?= base_url(); ?>kantor/admin/list/<?= $v->company_id; ?>"><?php echo $v->company;?></td>
                            ...
                            <td>
                                <a href="<?= base_url(); ?>perusahaan/admin/edit/<?= $v->company_id; ?>" class="badge badge-success">edit</a>
                                <a href="#newSubMenuModal" data-toggle="modal" class="badge badge-success">edit</a>
                                <a href="<?= base_url(); ?>perusahaan/admin/hapus/<?= $v->company_id; ?>" class="badge badge-danger">delete</a>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>					                                     
...
<div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url('perusahaan/admin/tambah'); ?>" method="post">
