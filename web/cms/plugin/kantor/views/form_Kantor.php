				...
				<form action="<?=base_url('kantor/tambah'); ?>" method="post" class="form-horizontal">
						...
						<div class="form-group"><label class="col-md-2 control-label">Nama Perusahaan</label>
						   ...
						   <div class="form-group row">
							...
							<div class="col-md-6"><select class="form-control m-b" name="provinsi">
								<option value="">--Pilih--</option>
							...
							<div class="col-md-6"><select class="form-control m-b" name="kabupaten">
								<option>Depok</option>
								<option>Bogor</option>
								<option>Bekasi</option>
								<option>Jakarta Utara</option> </select></div>
							</div>
