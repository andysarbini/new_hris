...
foreach( $mdl as $m){
	...
	if($c % 5 == 0) $slides .=  '<div class="row" id="product_center">'."\r\n";
	
	$slides .= '<div class="col-md-2">'."\r\n";
	
	
	$slides .= if_empty($m->pic_name) ? '<div class="text panel" style="display:none;"><a href="'.$url.$m->post_id.'/'.to_uri($m->pic_name).'"><h4>'.$m->pic_name.'</h4></a>'."\r\n":'';
