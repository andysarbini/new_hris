...
<div class="col-lg-7">
                    <div class="ibox float-e-margins">
                        ...
                        <form class="form-horizontal">
                            <div class="form-group"><label class="col-lg-2 control-label">ID Kantor</label>
                                    <div class="col-lg-10"><input type="text" name = "id_kantor" class="form-control"></div>
                            </div>
                            <div class="form-group"><label class="col-lg-2 control-label">NIP Karyawan</label>
                                    <div class="col-lg-10"><input type="text" name="nip_karyawan" class="form-control" ></div>
                            </div>
                            <div class="form-group"><label class="col-lg-2 control-label">Alamat</label>
                                    <div class="col-lg-10"><textarea class="col-lg-12">Wyswig Summernote Editor  <div class="summernote"></div></textarea></div>
                            </div>
						    <div class="form-group"><label class="col-lg-2 control-label">NPWP</label>
                                    <div class="col-lg-10"><input type="text" name="NPWP" class="form-control" ></div>
                            </div>
						    <div class="form-group"><label class="col-lg-2 control-label">Upload Photo</label>
                                <div class="col-lg-10">
                                    ...
                                    </div><span class="help-block m-b-none">css & js difile ini juga linknya.</span>
                                </div>
                            </div>   
