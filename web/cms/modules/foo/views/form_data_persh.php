                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <form class="form-horizontal">
                            ...
                            <div class="form-group"><label class="col-lg-2 control-label">Keterangan</label>
                                    <div class="col-lg-10"><textarea class="col-lg-12">Wyswig Summernote Editor  <div class="summernote"></div></textarea>
                                    <span class="help-block m-b-none">css & js difile ini juga linknya.</span></div>
