...
class api extends API_Controller {
	 ...
	 * @param unknown $iduri
	 */
	function getContent($count='single', $iduri=false, $out='return'){
		...
		//if($count == 'multiple') $ismultiple = true;
		
		//else $ismultiple = false;
		$ismultiple = false;
		
		$data = $this->content_m->__select($this->tbl_content, $select, $where, $ismultiple);
